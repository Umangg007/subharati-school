...
import {
  ...
  FaCalendarAlt, FaImages, FaNewspaper, FaBell, FaVideo,
  FaSearch, FaBars, FaTimes, FaSignOutAlt, FaChartLine, FaCog
} from 'react-icons/fa';
...
const AdminDashboard = () => {
  ...
  const renderSection = () => {
    ...
    switch (activeSection) {
      ...
      case 'analytics':  return <AnalyticsView pageVariants={pageVariants} />;
      case 'settings':   return <SettingsView pageVariants={pageVariants} />;
      default:
        return (
          <div className="coming-soon-card">
            <h2>Coming Soon</h2>
            <p>The <strong>{activeSection}</strong> module is under development.</p>
          </div>
        );
    }
  };
      ...
      <main className="main-content">
        ...
        <header className="dashboard-header">
          <div className="header-left">
            ...
            <div>
              <h1 className="capitalize">{activeSection === 'dashboard' ? 'Dashboard' : activeSection}</h1>
              <p>Subharati Pre-Primary School — Admin Portal</p>
            </div>
          </div>
